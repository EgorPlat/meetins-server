...
const appGateway_provider_1 = require("./providers/appGateway.provider");
let AppModule = class AppModule {
};
AppModule = __decorate([
    (0, common_1.Module)({
        controllers: [app_controller_1.AppController, settings_controller_1.SettingsController],
        providers: [app_service_1.AppService, settings_service_1.SettingsService, appGateway_provider_1.AppGatewayProvider],
        imports: [
        ...
        exports: [appGateway_provider_1.AppGatewayProvider]
    })
], AppModule);
