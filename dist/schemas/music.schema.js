...
__decorate([
    (0, swagger_1.ApiProperty)({ example: "Музыка", description: 'Название музыки' }),
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Music.prototype, "title", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 123, description: 'Айди автора' }),
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Music.prototype, "authorId", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'avatar.jpg', description: 'Постер к музыке' }),
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
], Music.prototype, "image", void 0);
Music = __decorate([
    (0, mongoose_1.Schema)()
], Music);
exports.Music = Music;
